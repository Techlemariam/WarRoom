    ...
    <main className="min-h-screen flex items-center justify-center p-6 bg-background">
      <div className="w-full max-w-sm glass p-8 space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] font-mono text-text-secondary uppercase">Secure Terminal Access</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-text-secondary uppercase">Access Key</label>
